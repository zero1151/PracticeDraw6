    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (mCount){
                    case 0:
                        imageView.animate().translationX(dpToPixel(100));break;
                    case 1:
                        imageView.animate().translationXBy(dpToPixel(-100));break;
                    case 2:
                        imageView.animate().translationY(dpToPixel(50));break;
                    case 3:
                        imageView.animate().translationYBy(dpToPixel(-50));break;
                    case 4:
                        imageView.animate().translationZ(dpToPixel(10));break;
                    case 5:
                        imageView.animate().translationZ(0);break;
