    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (mCount){
                    case 0:
                        imageView.animate().scaleX(1).scaleY(1).alpha(1).rotation(360).translationX(Utils.dpToPixel(200));break;
                    case 1:
                        imageView.animate().scaleX(0).scaleY(0).alpha(0).rotation(0).translationX(0);break;
